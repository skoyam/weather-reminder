...
class WeatherFetcher:
    ...
    def get_weather(self) -> dict:
        url = f"https://api.openweathermap.org/data/2.5/weather?q={self.location}&units=metric&appid={self.api_key}"
